      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            <span className="flex items-center gap-1"><Bed className="h-4 w-4" /> {item.bedrooms}</span>
            <span className="flex items-center gap-1"><Bath className="h-4 w-4" /> {item.bathrooms}</span>
          </div>
        </div>
        <div className="flex items-center justify-between pt-2 border-t">
          ...
          <Link href={`/items/${item._id}`}>
            <Button variant="outline" size="sm" className="text-xs hover:bg-orange-500 hover:text-white transition-colors">
              View Details
            </Button>
          </Link>
        </div>
